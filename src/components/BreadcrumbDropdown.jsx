...
function BreadcrumbDropdown({ items: crumbs }) {
  ...
  return (
    <Menu as="div" className="relative min-w-1.5xs px-3">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 max-h-fit w-full max-w-xs origin-top-right overflow-auto rounded-xl bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-zinc-800 dark:text-zinc-100 sm:text-sm">
          {rest.map((item) => (
