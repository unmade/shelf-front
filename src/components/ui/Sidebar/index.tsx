...
export function SidebarHeading({
  ...
  return (
    <div
      className={`mb-1 px-2 text-xs/6 font-medium text-gray-400 dark:text-zinc-500 ${className}`}
      {...props}
    />
  );
}
...
const sideBarItemActiveStyles = 'bg-gray-200 text-gray-800 dark:bg-zinc-700/50 dark:text-zinc-300';
